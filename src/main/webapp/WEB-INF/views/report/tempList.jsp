                    ...
                    <div class="card-header py-sm-1">
                        <h2 class="m-0 font-weight-bold text-primary">리포트
                            ...
                            <div style="display:flex; float: right"><h6>
                                ...
                                <button id="dateSort" value="hireDate" onclick="sortTest(dateSort.value)" ><%= hireDate %></button> ~
                                <input type="text" class="endDatepicker" id="date2" value="<%= endDate %>">
                                <button id="dateSort2" value="hireDate" onclick="sortTest(dateSort.value)"><%= hireDate %></button>
                            </h6></div>
                        </h2>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table style="text-align: center" class="table table-bordered" width="100%" cellspacing="0">
                                <thead>
                                <th rowspan="2">직원<button id="empName" value="requestDate" ><%= empName %></button></th>
                                <th rowspan="2">입사일<button id="hireDate" value="requestDate" ><%= hireDate %></button></th>
