        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="mb-5" style="display: inline-block; width: 100%">
                    <%= date.format(now) %>
                    <span style="float: right;">총 직원 수 : 200 명</span>
                </div>
                <div class="row">
                    <!-- Pie Chart -->
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <div class="dropdown no-arrow">
                                    <span id="_time"><%= time.format(now) %></span>
                                    <button id="_refresh" type="button"><img src="/static/img/home_refresh.jpg" width="15px"
                                                               height="15px" alt="새로고침"></button>
                                </div>
                            </div>
                            <!-- Card Body -->
                            <div class="card-body">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="card shadow mb-4">
                            <!-- Card Header - Dropdown -->
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">금주근무시간현황</h6>
                                <div class="dropdown no-arrow">
