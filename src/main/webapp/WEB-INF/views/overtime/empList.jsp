...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- 메인 내용 -->
            <div class="container">
                <div width="20%"><input type="button" value="엑셀 다운로드" style="float:right"></div>
                <!-- 검색창 -->
   ...
   <%--             <div class="clearfix" style="float:right" width="40%" >
                    <!-- 시작일 -->
                    <span class="dset">
   ...
   --%>             <h2 style="float:left">야근관리</h2>
                <table class="table table-bordered">
                    ...
                    <c:forEach var="data" items="${empList}">
                        <tr>
                            <td><a href="/readInfo?sequence=${data.sequence}">${data.empName}
                            </a></td>
                            <%--<td><a href="/read.do?bno=${overtimeList.bno}">${overtimeList.contents}</a></td>--%>
                            <td>${data.empJob}</td>
