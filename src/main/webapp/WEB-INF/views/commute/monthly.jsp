...
<div id="wrapper">
            ...
            <div class="container2">
                ...
                <div style="float: right ; width:600px ">
                            ...
                            <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                ...
                                <div class="input-group-append"
                                    ...
                                    <input type="text" class="form-control _date" id="monthpicker"
                                           ...
                                           value="${fn:substring(cri.regDt,0,7)}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-1"
                        ...
                        <a id="btnExport" href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50" download=""></i> 엑셀 다운로드</a>
                    </div>
                ...
                <div style="width: 100%; height: 600px; overflow: auto">
                    <table class="table table-bordered" style="table-layout: fixed" id="tblExport">
    ...
    <script type="text/javascript" src="/static/js/excel/jquery.techbytarun.excelexportjs.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnExport").on('click', function () {
                ...
                $(this).attr('download', 'montly"${fn:substring(cri.regDt,0,7)}"직무_${cri.keyword eq null ? 'All' : cri.keyword}.xls').attr('href', uri).attr('target', '_blank');
            })
        })
